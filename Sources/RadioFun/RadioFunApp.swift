...
struct QSYPreset: Identifiable {
    ...
    static let all: [QSYPreset] = [
        ...
        QSYPreset(label: "15m WSPR — 21.0946 (RX only)", mhz: 21.0946, mode: .wspr),
        QSYPreset(label: "20m WSPR — 14.0956 (RX only)", mhz: 14.0956, mode: .wspr),
        QSYPreset(label: "40m WSPR — 7.0386 (RX only)", mhz: 7.0386, mode: .wspr),
